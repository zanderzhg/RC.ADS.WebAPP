...
namespace RC.ADS.WebAPP.Controllers
{
    public class OAuthController : Controller
    {
        ...
        public readonly string appId =WeiXinConfig.appId;//与微信公众账号后台的AppId设置保持一致，区分大小写。
        private readonly string appSecret = WeiXinConfig.AppSecret;//与微信公众账号后台的AppId设置保持一致，区分大小写。
        ...
        public ActionResult Index(string returnUrl)
        {
            ...
            ViewData["UrlUserInfo"] =
                ...
                "http://www.circle-rect.com/oauth/UserInfoCallback?returnUrl=" + returnUrl.UrlEncode(),
                state, OAuthScope.snsapi_userinfo);
            RCLog.Info(this, ViewData["UrlUserInfo"].ToString());
            return Redirect(ViewData["UrlUserInfo"].ToString());
            //ViewData["UrlBase"] =
            //    OAuthApi.GetAuthorizeUrl(appId,
            //    "http://www.circle-rect.com/oauth2/BaseCallback?returnUrl=" + returnUrl.UrlEncode(),
